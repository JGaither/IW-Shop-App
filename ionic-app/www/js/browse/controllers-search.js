                ...
                Products.search($scope.status.q, LIMITVALUE).then(
                    function (ProductsMeta) {
                        ...
                        if (ProductsMeta == null) {
                            ...
                            var results = Utils.arrayValuesAndKeysProducts(ProductsMetaAdj);
                            if (results != null) {
                                $scope.ProductsMeta[$scope.categoryId] = Utils.sortArray(results, $scope.status.sortMethod, $scope.status.sortProperty);
                                // @dependencies
